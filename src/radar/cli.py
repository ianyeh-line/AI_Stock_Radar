...
def main() -> None:
    ...
    print(f"資料來源：官方確認 {source.get('official_confirmed', 0)} / Yahoo較新 {source.get('yahoo_newer_than_official', 0)} / Yahoo Only {source.get('yahoo_only', 0)} / Fallback {source.get('fallback', 0)}")
    print("今日可買進：")
